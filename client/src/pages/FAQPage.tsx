  ...
  const faqCategories = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '마이리얼트립 할인코드는 보통 발행된 달의 말일까지 유효합니다. 예를 들어 7월에 발행된 코드는 7월 30일까지 등록 가능합니다. 단, 코드를 마이페이지에서 쿠폰으로 등록한 후에는 등록일로부터 7일 이내에 사용해야 합니다. 7일이 지나면 쿠폰이 만료되므로, 여행 예약 직전에 코드를 등록하는 것을 권장합니다.',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '마이리얼트립 웹사이트(member.myrealtrip.com/coupon) 또는 앱에서 마이페이지 > 쿠폰 등록으로 이동합니다. 카드번호 앞 6자리 + 등록월(YYMMDD) 형식으로 입력하면 해당 카드사 전용 할인 쿠폰이 자동 발급됩니다. 예를 들어 삼성카드 1234-56XX-XXXX-XXXX 카드를 2026년 7월에 등록한다면 "123456260601"을 입력합니다.',
        },
        {
      ...
      items: [
        {
          ...
          answer: '예약을 취소하면 사용한 쿠폰은 자동으로 복구됩니다. 단, 쿠폰의 유효기간이 지난 경우에는 복구되지 않습니다. 예를 들어 9월 25일에 쿠폰을 사용하고, 10월 2일에 취소한 경우 쿠폰의 유효기간이 9월 30일이었다면 쿠폰이 복구되지 않습니다. 따라서 취소 가능성이 있다면 쿠폰 유효기간을 미리 확인하는 것이 좋습니다.',
        },
        {
