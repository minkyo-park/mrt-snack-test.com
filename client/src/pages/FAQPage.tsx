      ...
      items: [
        {
          ...
          answer: '예약을 취소하면 사용한 쿠폰은 자동으로 복구됩니다. 단, 쿠폰의 유효기간이 지난 경우에는 복구되지 않습니다. 예를 들어 8월 25일에 쿠폰을 사용하고, 9월 2일에 취소한 경우 쿠폰의 유효기간이 8월 31일이었다면 쿠폰이 복구되지 않습니다. 따라서 취소 가능성이 있다면 쿠폰 유효기간을 미리 확인하는 것이 좋습니다.',
        },
        {
