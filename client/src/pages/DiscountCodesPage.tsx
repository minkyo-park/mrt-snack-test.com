    ...
    linkprice: [
      {
        ...
        amount: '3,000원 (약 2%)',
        target: '해외 투어·티켓 전용',
        validity: '발급 2026.8.1~8.31 / 발급일로부터 7일 이내 사용',
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-blue-100">
              2026년 8월 마이리얼트립 모든 활성 할인코드 - 결제 시 복사해서 사용하세요
            </p>
          </div>
        </section>
        ...
        <section className="bg-amber-50 border-l-4 border-amber-500 py-6 px-4 md:px-0">
          <div className="container mx-auto">
            ...
            <ul className="text-sm text-amber-800 space-y-1">
              <li>• 모든 코드는 2026년 8월 31일까지 유효합니다</li>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">해외 투어·티켓 상품 전용 · 약 2% 할인 · 발급 2026년 8월 1일~8월 31일</p>
            </div>
